...
function CreateNewCollection({ onClose , addNewCollection }) { // Accept onClose prop from parent
  ...
  return (
    <>
      <div className="z-50 w-[100%] sm:h-[500px] sm:w-[700px] bg-[#202216] rounded absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-5 shadow-amber-50 shadow-xs">
